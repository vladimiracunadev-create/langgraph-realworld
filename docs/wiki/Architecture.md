...
> [!NOTE]
> **Version**: 4.7.0 | **Estado**: Industrial | **Audiencia**: Arquitectos Cloud, System Designers, DevOps
...
- **Backends operativos**: casos 01, 02, 03, 04, 05, 06, 08, 09, 10, 13, 14, 17, 19, 21 y 25 con endpoints reales, modo DEMO/LIVE y contratos de estado.
...
- **Seguridad automatizada**: GitHub Actions con pinning, CodeQL, `detect-secrets`, `pip-audit` y validacion dedicada de los 15 casos operativos.
