...
Portafolio de casos de uso con LangGraph, FastAPI y demos empresariales. El repositorio combina una capa documental fuerte con **18 casos operativos**: 01, 02, 03, 04, 05, 06, 07, 08, 09, 10, 11, 13, 14, 15, 17, 19, 21 y 25.
...
- **Operativo (v4.10.0)**: casos 01, 02, 03, 04, 05, 06, 07, 08, 11, 14, 15, 17, 19, 21 y 25 con backends reales, logicas condicionales robustas, modo DEMO/LIVE, UIs operativas e interactivas.
- **Industrial (v4.10.0)**: casos 09, 10 y 13 con backend real, streaming, estado tipado, observabilidad y documentacion operativa completa.
