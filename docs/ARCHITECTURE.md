...
> [!NOTE]
> **Version**: 4.0.0 | **Estado**: Industrial | **Audiencia**: Arquitectos Cloud, System Designers, DevOps
...
- **Backends operativos**: casos 01, 02, 03, 09, 10, 13, 19 y 25 con endpoints reales, modo DEMO/LIVE y contratos de estado.
...
- **Seguridad automatizada**: GitHub Actions con pinning, CodeQL, `detect-secrets`, `pip-audit` y validacion dedicada de los 8 casos operativos.
