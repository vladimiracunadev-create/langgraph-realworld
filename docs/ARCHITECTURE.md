...
- **Backends operativos**: casos 01, 02, 03, 04, 05, 06, 07, 08, 09, 10, 11, 12, 13, 14, 15, 17, 19, 21 y 25 con endpoints reales, modo DEMO/LIVE y contratos de estado.
...
- **Seguridad automatizada**: GitHub Actions con pinning, CodeQL, `detect-secrets`, `pip-audit` y validacion dedicada de los 19 casos operativos.
