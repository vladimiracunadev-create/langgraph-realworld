"""
auth.py — Middleware de autenticación y guardrails para Caso 12.

Soporta modo DEMO (sin credenciales) y modo OAuth2/OIDC con Bearer JWT
(opt-in vía USE_OAUTH2=true). Mismo patrón que casos 04, 05, 07, 11, 14.
"""
