"""
auth.py — Middleware de autenticación y guardrails para Caso 04.

Idéntico al patrón del Caso 03: soporta modo DEMO (sin credenciales)
y modo OAuth2/OIDC con Bearer JWT (opt-in vía USE_OAUTH2=true).
"""
