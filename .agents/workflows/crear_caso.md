---
description: Crear un nuevo caso de uso LangGraph desde cero y levantarlo
---

# Workflow: Creación de Nuevo Caso LangGraph

Este workflow te guía en el proceso para crear un nuevo caso de LangGraph en el repositorio, de manera aislada y sin romper los casos anteriores. 

Sigue estos pasos estrictamente cuando el usuario te pida crear o levantar un nuevo caso:
